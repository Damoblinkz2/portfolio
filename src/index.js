 ...
 const Content = () => {
  return(
    <section>
           ...
           <a href='https://drive.google.com/file/d/18z7k3MQMBXpMmi9K3vvO2GJY39C6y5T_/view?usp=drivesdk'>Download CV</a>
          </span>
		   </div>
...
const About = () => {
  return(
    <div className="about-container about">
      ...
      <h2>About Me</h2>
      <h4>Web Developer</h4>
      <p>Hello,My name is Yusuf Adedamola. I am a frontend web developer with 3+ years of experience in this field.</p>
      <p>My aim is to leverage a proven knowledge of a web developer skills to sufficiently fill the role of a frontend web developer in your company/team.</p>
      <span className='hire-btn'>
           <a href='mailto:adedamolatomide@gmail.com'>Hire me</a>
          </span>
			    <span className='down-cv'>
...
const services =[
  {
    ...
    details:"I have the ability and the necessary skills to collaborate with other developers in team in other the achieve the team's objective."
  },
  {
    id:2,
    class:'box-2',
    ...
    details:'I build the front UI of a website with front end languages and technologies that makes the webpages load fast without leaving SEO practice behind.'
  },
  {
    id:3,
    class:'box-3',
...
const eachService = services.map((service) => {
      ...
      <div className='col-lg-4 column' key={service.id}>
        <div className={service.class}>
          <p className='numbering'><span>{service.spanNo}</span></p>
...
const Footer = () =>{
  ...
  <h2>MY PORTFOLIO</h2>
	...
	<div class="social-icons">
  	<a href="mailto:adedamolatomide@gmail.com"><i className="fab fa-google"></i></a>
	  <a href="https://twitter.com/Damoblinkz?t=I6soy_66vEfb000amZpNMg&s=09"><i className="fab fa-twitter"></i></a>
  	<a href="https://www.instagram.com/iam_damoblinkz/"><i className="fab fa-instagram"></i></a>
	  <a href="https://www.linkedin.com/in/adedamola-olatomide-19191b213"><i className="fab fa-linkedin"></i></a>
	 </div>
